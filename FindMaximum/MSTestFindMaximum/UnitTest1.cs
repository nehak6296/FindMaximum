...
namespace MSTestFindMaximum
{
    ...
    public class UnitTest1
    {
        ...
        public void Given_MaxStringNumberAt1stPosition_WhenChecked_ThenReturn_SameNumber()
        {
            ...
            string result = MaximumNumberCheck.MaximumStringNumber("44", "33", "22");
            //Assert
            Assert.AreEqual(expectedResult, result);
        }
        ...
        [TestMethod]
        //Act
        public void Given_MaxStringNumberAt3rdPosition_WhenChecked_ThenReturn_SameNumber()
        {
            string expectedResult = "44";
            string result = MaximumNumberCheck.MaximumStringNumber("33", "22", "44");
            //Assert
            Assert.AreEqual(expectedResult, result);
        }
